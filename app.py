...
print('Здравствуйте, это игра "Крестики - нолики". Прошу вас ознакомиться с правилами, по которым Вы будете играть. Не спешите, это займет не более 10 секунд Вашего времени.')
print('Первый ход делает Игрок 1, он ходит крестиками, Игрок 2, соответственно, ставит нолики.')
print('Для победы необходимо расставить крестики или нолики в любом направлении и порядке по горизонтали, вертикали или диагонали.')
print('Для того чтобы поставить крестик или нолик в определенную позицию, игроку в свой ход необходимо написать одной цифрой без пробелов и дополнительных знаков номер желаемой клетки. Будьте внимательны: нельзя ставить крестик или нолик на уже занятую позицию!')
print('Если ни один игрок не выиграл, а ходы закончились, результатом игры считается ничья.', 'Веселой игры!')
